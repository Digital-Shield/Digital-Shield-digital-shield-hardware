...
The `storage` folder contains the implementation of DigitShield's internal storage, which is common for both Legacy (DigitShield One) and Core (DigitShield T). This README also contains a detailed description of the cryptographic design.
