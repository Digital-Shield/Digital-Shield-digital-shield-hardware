# Use of SLIP-39 in DigitShield-core
...
This does not quite match DigitShield's use of the "passphrase protection" feature, namely
...
## Seed handling in DigitShield

DigitShield stores a _mnemonic secret_ in a storage field `_MNEMONIC_SECRET`. This is the
...
Only the functions denoted in **bold** are implemented in DigitShield-core. Recovery shares
