...
red square in the upper right corner of DigitShield screen.
...
Internal DigitShield's storage is emulated and stored in the `/var/tmp/DigitShield.flash` file by
default. Deleting this file is similar to calling _wipe device_. You can also find
`/var/tmp/DigitShield.sdcard` for SD card.
...
This will create a profile directory in your home `~/.DigitShieldemu/foobar` containing
