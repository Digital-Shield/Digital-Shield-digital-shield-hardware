...
class Emulator:
    ...
    def __init__(
        ...
        *,
        ...
        if logfile:
            ...
            self.logfile = self.profile_dir / "digitshield.log"
    ...
    def start(self) -> None:
        ...
        (self.profile_dir / "digitshield.pid").write_text(str(self.process.pid) + "\n")
        (self.profile_dir / "digitshield.port").write_text(str(self.port) + "\n")
    ...
    def stop(self) -> None:
        ...
        _rm_f(self.profile_dir / "digitshield.pid")
        _rm_f(self.profile_dir / "digitshield.port")
        self.process = None
...
class CoreEmulator(Emulator):
    STORAGE_FILENAME = "digitshield.flash"
    ...
    def __init__(
        ...
        **kwargs: Any,
        ...
        self.sdcard = self.profile_dir / "digitshield.sdcard"
