...
if TYPE_CHECKING:
    ...
    class Features(protobuf.MessageType):
        ...
        digitalshield_version: "str | None"
        digitalshield_serial: "str | None"
        ...
        def __init__(
            ...
            *,
            ...
            digitalshield_version: "str | None" = None,
            digitalshield_serial: "str | None" = None,
    ...
    class EthereumGetPublicKeyDigitalshield(protobuf.MessageType):
        address_n: "list[int]"
        show_display: "bool | None"
        chain_id: "int | None"
        ...
        @classmethod
        def is_type_of(cls, msg: Any) -> TypeGuard["EthereumGetPublicKeyDigitalshield"]:
            return isinstance(msg, cls)

    class EthereumPublicKeyDigitalshield(protobuf.MessageType):
        node: "HDNodeType"
        xpub: "str"
        ...
        @classmethod
        def is_type_of(cls, msg: Any) -> TypeGuard["EthereumPublicKeyDigitalshield"]:
            return isinstance(msg, cls)

    class EthereumGetAddressDigitalshield(protobuf.MessageType):
        address_n: "list[int]"
        show_display: "bool | None"
        chain_id: "int | None"
        ...
        @classmethod
        def is_type_of(cls, msg: Any) -> TypeGuard["EthereumGetAddressDigitalshield"]:
            return isinstance(msg, cls)

    class EthereumAddressDigitalshield(protobuf.MessageType):
        address: "str | None"
        ...
        @classmethod
        def is_type_of(cls, msg: Any) -> TypeGuard["EthereumAddressDigitalshield"]:
            return isinstance(msg, cls)

    class EthereumSignTxDigitalshield(protobuf.MessageType):
        address_n: "list[int]"
        nonce: "bytes"
        gas_price: "bytes"
        gas_limit: "bytes"
        ...
        @classmethod
        def is_type_of(cls, msg: Any) -> TypeGuard["EthereumSignTxDigitalshield"]:
            return isinstance(msg, cls)

    class EthereumSignTxEIP1559Digitalshield(protobuf.MessageType):
        address_n: "list[int]"
        nonce: "bytes"
        max_gas_fee: "bytes"
        ...
        data_length: "int"
        chain_id: "int"
        access_list: "list[EthereumAccessListDigitalshield]"
        ...
        def __init__(
            ...
            *,
            ...
            chain_id: "int",
            address_n: "list[int] | None" = None,
            access_list: "list[EthereumAccessListDigitalshield] | None" = None,
            to: "str | None" = None,
            data_initial_chunk: "bytes | None" = None,
        ) -> None:
            pass
        ...
        @classmethod
        def is_type_of(cls, msg: Any) -> TypeGuard["EthereumSignTxEIP1559Digitalshield"]:
            return isinstance(msg, cls)

    class EthereumTxRequestDigitalshield(protobuf.MessageType):
        data_length: "int | None"
        signature_v: "int | None"
        signature_r: "bytes | None"
        signature_s: "bytes | None"
        ...
        @classmethod
        def is_type_of(cls, msg: Any) -> TypeGuard["EthereumTxRequestDigitalshield"]:
            return isinstance(msg, cls)

    class EthereumTxAckDigitalshield(protobuf.MessageType):
        data_chunk: "bytes"
        ...
        @classmethod
        def is_type_of(cls, msg: Any) -> TypeGuard["EthereumTxAckDigitalshield"]:
            return isinstance(msg, cls)

    class EthereumSignMessageDigitalshield(protobuf.MessageType):
        address_n: "list[int]"
        message: "bytes"
        chain_id: "int | None"
        ...
        @classmethod
        def is_type_of(cls, msg: Any) -> TypeGuard["EthereumSignMessageDigitalshield"]:
            return isinstance(msg, cls)

    class EthereumMessageSignatureDigitalshield(protobuf.MessageType):
        signature: "bytes"
        address: "str"
        ...
        @classmethod
        def is_type_of(cls, msg: Any) -> TypeGuard["EthereumMessageSignatureDigitalshield"]:
            return isinstance(msg, cls)

    class EthereumVerifyMessageDigitalshield(protobuf.MessageType):
        signature: "bytes"
        message: "bytes"
        address: "str"
        chain_id: "int | None"
        ...
        @classmethod
        def is_type_of(cls, msg: Any) -> TypeGuard["EthereumVerifyMessageDigitalshield"]:
            return isinstance(msg, cls)

    class EthereumSignTypedHashDigitalshield(protobuf.MessageType):
        address_n: "list[int]"
        ...
        @classmethod
        def is_type_of(cls, msg: Any) -> TypeGuard["EthereumSignTypedHashDigitalshield"]:
            return isinstance(msg, cls)

    class EthereumTypedDataSignatureDigitalshield(protobuf.MessageType):
        signature: "bytes"
        address: "str"
        ...
        @classmethod
        def is_type_of(cls, msg: Any) -> TypeGuard["EthereumTypedDataSignatureDigitalshield"]:
            return isinstance(msg, cls)
    ...
    class EthereumAccessListDigitalshield(protobuf.MessageType):
        address: "str"
        ...
        @classmethod
        def is_type_of(cls, msg: Any) -> TypeGuard["EthereumAccessListDigitalshield"]:
            return isinstance(msg, cls)

    class EthereumSignTypedDataDigitalshield(protobuf.MessageType):
        address_n: "list[int]"
        primary_type: "str"
        ...
        @classmethod
        def is_type_of(cls, msg: Any) -> TypeGuard["EthereumSignTypedDataDigitalshield"]:
            return isinstance(msg, cls)

    class EthereumTypedDataStructRequestDigitalshield(protobuf.MessageType):
        name: "str"
        ...
        @classmethod
        def is_type_of(cls, msg: Any) -> TypeGuard["EthereumTypedDataStructRequestDigitalshield"]:
            return isinstance(msg, cls)

    class EthereumTypedDataStructAckDigitalshield(protobuf.MessageType):
        members: "list[EthereumStructMemberDigitalshield]"

        def __init__(
            self,
            *,
            members: "list[EthereumStructMemberDigitalshield] | None" = None,
        ) -> None:
            pass

        @classmethod
        def is_type_of(cls, msg: Any) -> TypeGuard["EthereumTypedDataStructAckDigitalshield"]:
            return isinstance(msg, cls)

    class EthereumTypedDataValueRequestDigitalshield(protobuf.MessageType):
        ...
        @classmethod
        def is_type_of(cls, msg: Any) -> TypeGuard["EthereumTypedDataValueRequestDigitalshield"]:
            return isinstance(msg, cls)

    class EthereumTypedDataValueAckDigitalshield(protobuf.MessageType):
        value: "bytes"
        ...
        @classmethod
        def is_type_of(cls, msg: Any) -> TypeGuard["EthereumTypedDataValueAckDigitalshield"]:
            return isinstance(msg, cls)

    class EthereumStructMemberDigitalshield(protobuf.MessageType):
        type: "EthereumFieldTypeDigitalshield"
        name: "str"
        ...
        @classmethod
        def is_type_of(cls, msg: Any) -> TypeGuard["EthereumStructMemberDigitalshield"]:
            return isinstance(msg, cls)

    class EthereumFieldTypeDigitalshield(protobuf.MessageType):
        data_type: "EthereumDataTypeDigitalshield"
        size: "int | None"
        entry_type: "EthereumFieldTypeDigitalshield | None"
        ...
        def __init__(
            ...
            *,
            data_type: "EthereumDataTypeDigitalshield",
            size: "int | None" = None,
            entry_type: "EthereumFieldTypeDigitalshield | None" = None,
            struct_name: "str | None" = None,
        ) -> None:
            pass

        @classmethod
        def is_type_of(cls, msg: Any) -> TypeGuard["EthereumFieldTypeDigitalshield"]:
            return isinstance(msg, cls)
