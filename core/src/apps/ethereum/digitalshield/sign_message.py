...
from trezor.messages import EthereumMessageSignatureDigitalshield as EthereumMessageSignature
...
if TYPE_CHECKING:
    from trezor.messages import EthereumSignMessageDigitalshield as EthereumSignMessage
