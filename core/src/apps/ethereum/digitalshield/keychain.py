...
if TYPE_CHECKING:
    ...
    from trezor.messages import (
        EthereumGetAddressDigitalshield as EthereumGetAddress,
        EthereumGetPublicKeyDigitalshield as EthereumGetPublicKey,
        EthereumSignMessageDigitalshield as EthereumSignMessage,
        EthereumSignTxDigitalshield as EthereumSignTx,
        EthereumSignTxEIP1559Digitalshield as EthereumSignTxEIP1559,
        EthereumSignTypedDataDigitalshield as EthereumSignTypedData,
        EthereumSignTypedHashDigitalshield as EthereumSignTypedHash,
    )
