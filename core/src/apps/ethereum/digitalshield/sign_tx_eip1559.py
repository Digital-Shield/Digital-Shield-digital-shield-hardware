...
from ..layout import require_confirm_eip1559_fee, require_show_overview, require_confirm_fee_ton
...
if TYPE_CHECKING:
    from trezor.messages import EthereumSignTxEIP1559Digitalshield as EthereumSignTxEIP1559
...
async def sign_tx_eip1559(
    ...
    #修改bnb图标
    if ctx.icon_path == "A:/res/evm-bnb.png":
        ctx.icon_path = "A:/res/evm-bsc.png"
    ...
    network_suffix = "Ethereum"
    if msg.chain_id == 1:
        network_suffix = "Ethereum"
    elif msg.chain_id == 137:
        network_suffix = "Polygon"
    elif msg.chain_id == 56:
        network_suffix = "BNB Smart Chain"
    await confirm_final(ctx, network_suffix)
