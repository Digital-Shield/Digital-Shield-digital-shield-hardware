...
from trezor.messages import EthereumPublicKeyDigitalshield as EthereumPublicKey, HDNodeType
...
if TYPE_CHECKING:
    from trezor.messages import EthereumGetPublicKeyDigitalshield as EthereumGetPublicKey
