...
#define FMC_SDRAM_LTDC_BUFFER_LEN (1 * 1024 * 1024)
...
#define FMC_SDRAM_LVGL_BUFFER_ADDRESS \
  (FMC_SDRAM_LTDC_BUFFER_ADDRESS + FMC_SDRAM_LTDC_BUFFER_LEN)
#define FMC_SDRAM_LVGL_BUFFER_LEN (1 * 1024 * 1024)

#define FMC_SDRAM_CAMERA_BUFFER_ADDRESS \
  (FMC_SDRAM_LVGL_BUFFER_ADDRESS + FMC_SDRAM_LVGL_BUFFER_LEN)
#define FMC_SDRAM_CAMERA_BUFFER_LEN (512 * 1024)

#define FMC_SDRAM_IMAGE_BUFFER_ADDRESS \
  (FMC_SDRAM_CAMERA_BUFFER_ADDRESS + FMC_SDRAM_CAMERA_BUFFER_LEN)
#define FMC_SDRAM_IMAGE_BUFFER_LEN (512 * 1024)

#define FMC_SDRAM_QUIRC_BUFFER_ADDRESS \
  (FMC_SDRAM_IMAGE_BUFFER_ADDRESS + FMC_SDRAM_IMAGE_BUFFER_LEN)
#define FMC_SDRAM_QUIRC_BUFFER_LEN (512 * 1024)

#define FMC_SDRAM_USER_HEAP_ADDRESS \
  (FMC_SDRAM_QUIRC_BUFFER_ADDRESS + FMC_SDRAM_QUIRC_BUFFER_LEN)
