...
typedef struct _Features {
    ...
    bool backup_only;
    bool has_digitalshield_version;
    char digitalshield_version[32];
...
#define Features_digitalshield_version_tag       508
...
X(a, STATIC,   OPTIONAL, STRING,   digitalshield_version, 508) \
