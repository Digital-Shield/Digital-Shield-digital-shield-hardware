...
LCD_TIME_SEQUENCE lcd_time_seq = {.hsync = GC9503V_480X800_HSYNC,
                                  .hfp = GC9503V_480X800_HFP,
                                  .hbp = GC9503V_480X800_HBP,
                                  .vsync = GC9503V_480X800_VSYNC,
                                  .vfp = GC9503V_480X800_VFP,
                                  .vbp = GC9503V_480X800_VBP};
...
void gc9503v_init_sequence(void) {
  ...
  gc9503_lcd_init_cmd_t init_cmds[] = {
      ...
      {0x64, 16,
       (uint8_t[]
       ){0x38, 0x09, 0x03, 0x1e, 0x03, 0x03, 0x38, 0x07, 0x03, 0x20, 0x03, 0x03, 0x7a, 0x7a, 0x7a, 0x7a}},
      {0x65, 16,
       (uint8_t[]
       ){0x38, 0x05, 0x03, 0x22, 0x03, 0x03, 0x38, 0x03, 0x03, 0x24, 0x03, 0x03, 0x7a, 0x7a, 0x7a, 0x7a}},
      {0x66, 16,
       (uint8_t[]
       ){0x98, 0x11, 0x03, 0x37, 0x03, 0x03, 0x98, 0x11, 0x03, 0x37, 0x03, 0x03, 0x7a, 0x7a, 0x7a, 0x7a}},
      {0x67, 16,
       (uint8_t[]
       ){0x93, 0x37, 0x08, 0x11, 0x03, 0x03, 0x93, 0x37, 0x08, 0x11, 0x03, 0x03, 0x7a, 0x7a, 0x7a, 0x7a}},
