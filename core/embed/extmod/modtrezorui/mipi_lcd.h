...
#define LCD_RESET_CLK_ENABLE() __HAL_RCC_GPIOG_CLK_ENABLE()
#define LCD_RESET_PIN GPIO_PIN_3
#define LCD_RESET_GPIO_PORT GPIOG

/* pcb v1.1 LCD reset pin */
#define V11_LCD_RESET_CLK_ENABLE() __HAL_RCC_GPIOJ_CLK_ENABLE()
#define V11_LCD_RESET_PIN GPIO_PIN_6
#define V11_LCD_RESET_GPIO_PORT GPIOJ
